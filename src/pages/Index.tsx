  ...
  return <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <header className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-3 items-center gap-8">
          {/* Left: Navigation - Equal width to right side */}
          ...
          {/* Right: CTA Button - Equal width to left side */}
          <div className="flex justify-end">
            <Button onClick={() => setShowMobileSignup(true)} className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black font-bold px-6 py-3">
              🎉 Start Free Trial
            </Button>
          </div>
        </div>
      ...
      <section className="container mx-auto px-6 py-16 text-center">
        ...
        {/* Perfectly Centered Button Group */}
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
          <Button onClick={() => setShowMobileSignup(true)} size="lg" className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black font-bold py-4 px-8 text-lg min-w-[240px]">
            🎉 Start 24-Hour Free Trial
          </Button>
          <Button variant="outline" size="lg" className="border-yellow-500 text-yellow-400 hover:bg-yellow-500 hover:text-black py-4 px-8 text-lg min-w-[240px]" onClick={() => document.getElementById('features')?.scrollIntoView({
          behavior: 'smooth'
        })}>
            📺 See All Features
          </Button>
        ...
        {/* Perfectly Balanced Feature Grid */}
      ...
      <section id="devices" className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Works on Every Device You Own</h2>
        ...
        {/* Perfectly Balanced 4-Column Grid */}
        <div className="grid md:grid-cols-4 gap-8 mb-16">
          <Card className="bg-gray-800 border-gray-700 text-center">
            <CardHeader className="pb-4">
              <div className="flex justify-center mb-4">
                <Tv className="w-12 h-12 text-yellow-400" />
              </div>
          ...
          <Card className="bg-gray-800 border-gray-700 text-center">
            <CardHeader className="pb-4">
              <div className="flex justify-center mb-4">
                <Monitor className="w-12 h-12 text-yellow-400" />
              </div>
              <CardTitle className="text-lg">💻 Office & Study</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-300 text-sm mb-4">
          ...
          <Card className="bg-gray-800 border-gray-700 text-center">
            <CardHeader className="pb-4">
              <div className="flex justify-center mb-4">
                <Tablet className="w-12 h-12 text-yellow-400" />
              </div>
              <CardTitle className="text-lg">📱 Personal Devices</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-300 text-sm mb-4">
          ...
          <Card className="bg-gray-800 border-gray-700 text-center">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-lg">🌍 Anywhere</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-300 text-sm mb-4">
        ...
        <div className="flex justify-center">
          <Card className="bg-gradient-to-r from-green-800 to-blue-800 border-green-500 max-w-md">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-bold mb-3">Just Need Internet</h3>
      ...
      {/* Perfectly Balanced Features Section */}
      <section id="features" className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Why Choose SteadyStream TV?</h2>
        </div>
        
        {/* Perfect 3-Column Grid with Equal Spacing */}
        <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <div className="w-20 h-20 bg-yellow-500 rounded-full flex items-center justify-center">
                <img src="/lovable-uploads/310d5e27-e7eb-4960-8cec-cb6ef89a79cd.png" alt="SteadyStream" className="w-12 h-12 object-contain" />
              </div>
            </div>
