...
const Player = () => {
  ...
  const channels = [
    { id: 1, name: "SteadyStream Sports", url: "https://example.com/stream1" },
    { id: 2, name: "SteadyStream Movies", url: "https://example.com/stream2" },
    { id: 3, name: "SteadyStream News", url: "https://example.com/stream3" },
    { id: 4, name: "SteadyStream Entertainment", url: "https://example.com/stream4" },
    { id: 5, name: "SteadyStream Kids", url: "https://example.com/stream5" },
  ];
            ...
            <div className="bg-dark-200 rounded-xl p-4 border border-gray-800">
              ...
              <div className="space-y-2">
                <Input 
                  ...
                  className="bg-dark-300 border-gray-700 mb-4"
                />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        size="icon"
                        onClick={handlePlay}
                        className="border-gray-700 hover:bg-dark-100"
                      >
