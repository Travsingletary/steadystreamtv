      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <DeviceCard 
            ...
            description="FireStick, Apple TV, Roku"
            delay={0.2}
          />
          <DeviceCard 
          ...
          <DeviceCard 
            icon={<Laptop size={40} />}
            title="Computers"
            description="Windows, Mac & Web"
            delay={0.4}
          />
        </div>

        <div className="mt-16 bg-dark-200 rounded-xl border border-gray-800 p-6 md:p-10 opacity-0 animate-fade-in" style={{ animationDelay: "0.6s" }}>
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2 flex justify-center mt-6 md:mt-0">
              <div className="relative bg-black/50 p-2 rounded-xl border border-gray-800 max-w-sm">
                <img
                ...
                />
                <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 bg-black/70 px-4 py-2 rounded-full border border-gold/20">
                  <span className="text-gold text-sm font-medium">SteadyStream for FireStick</span>
                </div>
              </div>
            </div>
          </div>
...
const DeviceCard = ({ 
  ...
  <div 
    className="bg-dark-200 rounded-lg p-6 border border-gray-800 hover:border-gold/30 transition-all duration-300 flex flex-col items-center text-center opacity-0 animate-fade-in"
...
const DeviceFeature = ({ text }: { text: string }) => (
