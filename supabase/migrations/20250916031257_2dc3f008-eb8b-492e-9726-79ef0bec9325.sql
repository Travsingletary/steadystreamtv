-- Drop policies that depend on Stripe columns
...
-- Recreate simplified payment policies (without Stripe dependencies)
...
ON public.payments 
FOR SELECT 
USING (true); -- Simplified since we don't have user association anymore